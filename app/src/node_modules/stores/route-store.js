...
var RouteStore = Fluxxor.createStore({
  initialize: function (options) {
    ...
    this.currentRoute     = urlObj.pathname // ie 'resource' curently incorrect
    this.currentParams    = options.params //not used /:id
    this.currentQuery     = qs.parse(urlObj.query) || {}
  ...
  //Temp method to get things going
  handlePathTransition: function (path) {
  ...
  handleIndicatorTransition: function (payload) {
    var pathname = this.router.makePath('indicator', { issueRoute: payload.issueRoute, indicatorRoute: payload.indicatorRoute }).substring(1)
