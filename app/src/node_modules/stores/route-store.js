...
var RouteStore = Fluxxor.createStore({
 ...
 handleQueryToggle: function (payload) {
  ...
  handleDimensionUpdate: function (payload) {
    ...
    // todo remove all queries for dimensions hiegher than the one set
    // remove from query when already present
    var unset = ''
 ...
 handleFieldReplace: function (payload, query) {
   ...
   var query = typeof query !== 'undefined' ? query : _.clone(this.router.getCurrentQuery())
