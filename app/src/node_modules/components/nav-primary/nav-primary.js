    ...
    <div className='nav-primary'>
      <Grid className=''>
        <Row className='nav-primary-row'>
          <Col md={2} xs={2} className='nav-primary-label serif'>
            <div>Explore indicators by issue</div>
          </Col>
          <Col md={10} xs={10}>
            <ul className="list-inline nav-primary-list">
              {
                _.map(this.props.items,function (item, i, items) {
                  ...
                  return (
                    <li key={item.id} className={item.active ? 'nav-primary-li active' : 'nav-primary-li'}  style={{width:width}}>
                      <a className='btn'
                          href='#'
