...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var className = this.props.shouldHide ? 'share-modal hide' : 'share-modal'
		...
		return (
      <div className={className}  onClick={this.handleCloseClick()}>
        <div className='share-modal-inner' onClick={this.stopPropagation()}>
        <Grid>
          <Row className="share-modal-row">
            <Col md={5} xs={5}>
              ...
              <div className="share-modal-control">
                <a className='btn btn-share-modal share-modal-social' href={this.props.facebookShare} target="_blank">
