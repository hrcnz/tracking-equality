          ...
          <Row className="share-modal-row">
            <Col md={5}>
              ...
              <div className="share-modal-control">
                <a className='btn share-modal-social' href={facebookShare} target="_blank">
                  <span className="icon-social-facebook"></span>
                  Facebook
                </a>
                <a className='btn share-modal-social' href={twitterShare} target="_blank">
                  <span className="icon-social-twitter"></span>
                  Twitter
                </a>
              </div>
                <a className='btn share-modal-social' href={linkedinShare} target="_blank">
            ...
            <Col md={5}>
              ...
              <h4>Copy link</h4>
              <div className="share-modal-control">
                <input className="share-modal-link" type='text' value={this.props.currentHREF} readOnly>{}</input>
              </div>
            </Col>
            <div className="share-modal-close">
              <a href="#" className={'btn'}  onClick={this.handleCloseClick()}  title="Close share modal">
