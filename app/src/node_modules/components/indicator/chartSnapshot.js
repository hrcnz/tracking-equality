...
module.exports = React.createClass({
  ...
  isNewGroup : function(previousGroups,currentGroups){
    ...
    // new group of groups if all groups are different
    if (_.isEmpty(previousGroups))  {
      return false
    } else {
      return _(previousGroups).every(function(val,key){
        return val !== currentGroups[key]
      })
    } 
  },
  ...
  formatRowDataGrouped : function (datum, maxValue, refValue, currentGroups) {
