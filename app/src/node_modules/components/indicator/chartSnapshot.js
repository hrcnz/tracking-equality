...
module.exports = React.createClass({
      ...
      <tbody className='table-body'>     
        {
          _.map(groupProduct,function(group){
            ...
            return (
                <TableRow rowData = {this.formatRowDataGrouped(
  ...
  formatRowDataGrouped : function (datum, maxValue, refValue) {
    ...
    //remember previous Groups    
    _.each(this.props.breakdowns,function(bd){
      this.previousGroups[bd.id] = datum[bd.id]
    },this)
