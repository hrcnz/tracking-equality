...
module.exports = React.createClass({
  ...
  renderFilterGroup: function (dataGroups, breakdown) {
	...
	handleClearAll: function (field) {
		var self = this
		return function (e) {
			self.props.flux.actions.indicator.selectFilter(field, 'all')
		}
	},
