    ...
    return (
      <Grid className='explore-data'>
        ...
        <Row className='filters'>
          <Col className='first dimension' xs={3} md={2} >
						<p>1st dimension</p>
            {first}
          </Col>
          <Col className={displaySecond ? 'and' : 'hide'} xs={2} md={1} >
            and
          </Col>
          <Col className={displaySecond ? 'second dimension' : 'hide'} xs={3} md={2} >
           {second}
          </Col>
          <Col className={displayThird ? 'and' : 'hide'} xs={2} md={1} >
            and
          </Col>
          <Col className={displayThird ? 'third dimension' : 'hide'} xs={3} md={2} >
           {third}
          </Col>
        </Row>
      </Grid>
