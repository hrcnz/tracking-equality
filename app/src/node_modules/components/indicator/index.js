...
module.exports = React.createClass({
  ...
  render: function () {
		...
		log('referenceGroup', referenceGroup)
	 ...
	 //create our special query function that will filter by the query string but also include the referenceGroup
		...
		//filter and sort all data to those that match our params or defaults //TODO do this on the store?
		currentData = _(data)
			.reject({ value: '' })
		...
		if (this.props.query.dataset === 'all') {
			...
			View = (
				<Snapshot
					...
					data={this.formatTableData(currentData, dataGroups, maxValue)}
