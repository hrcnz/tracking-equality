...
//     log('data - filtered', data)
      ...
      howToReadData = this.truncateText(indicator.howtoreaddata, 55, !this.state.explanationCollapsed)
      aboutIndicator = this.truncateText(indicator.aboutindicator, 30, !this.state.explanationCollapsed)
