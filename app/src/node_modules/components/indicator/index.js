...
module.exports = React.createClass({
  ...
  render: function () {
	...
	getDataGroups: function (data, breakdownIds, dimensions) {
		...
		var dataGroupsByDimension = []
		//'age' is a special case generated from present data
		...
		_.each(dimensions, function (dimension) {
			var dg = dimension === 'age' ? this.getAgeGroups(data) : _.filter(dataGroups, { breakdown: dimension })
			dataGroupsByDimension.push(dg)
		}, this)
	...
	getDimensions: function (query, breakdownIds) {
		...
		if (dimensions.length === 0) dimensions.push(breakdownIds[0])
		return dimensions
	},
