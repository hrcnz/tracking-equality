...
module.exports = React.createClass({
  ...
  getStateFromFlux: function () {
    ...
    return {
      ...
      datasetsLoading: flux.store('datasets').isLoading(),
  ...
  render: function () {
    ...
    || this.state.dataGroupsLoading 
    || this.state.datasetsLoading 
    || this.state.dataLoading ) {
      ...
      // rank can only have one breakdown
      if (indicator.datatype === 'rank' && breakdownIds.length) {
        breakdownIds.splice(1,breakdownIds.length-1)
      }
...
//      log('sortedDatasets - with ranges',sortedDatasets)
      ...
      dataSetFilter = {}
			if (typeof this.props.query.dataset !== 'undefined') {
...
//      log('data',data)
      ...
      // filter by dataset
      data = _.filter(data, dataSetFilter)              
...
//      log('dataGroupsByActiveBreakdowns',dataGroupsByActiveBreakdowns)
      ...
      if ((indicator.datatype === 'categorical' || indicator.datatype === 'part-to-whole')
        ...
        sortBy = 'group'
        sortOptions = ['group']
      } else if (indicator.datatype === 'rank'){
        sortBy = 'rank'
        sortOptions = ['rank']
      } else {
...
//      log('dataQuery', dataQuery)
      ...
      data = this.filterByQuery(data,dataQuery)

//     log('data - filtered', data)
      
      activeGroups = this.filterDataGroupsByQuery(dataGroupsByActiveBreakdowns, dataQuery)     
  ...
  extractBreakdownGroups : function(query, data, breakdownId){
    ...
    return _(groupIds)
      ...
      .sortBy('title') //display order by title
      .value()
