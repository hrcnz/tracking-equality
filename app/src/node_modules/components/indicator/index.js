...
//     log('data - filtered', data)
      ...
      howToReadData = truncateText(indicator.howtoreaddata, 55, !this.state.explanationCollapsed)
      aboutIndicator = truncateText(indicator.aboutindicator, 30, !this.state.explanationCollapsed)

      ShowMore = (
        <div className="indicator-show-more">
            ...
            <Grid className='page-section indicator-section-intro'>
              ...
              <Row className='indicator-explain'>
                <Col className='indicator-title' md={9}>
                  ...
                  <div className='indicator-explain-text' dangerouslySetInnerHTML={{
                ...
                <Col className='indicator-definitions' md={3}>
                  ...
                  <div className='small indicator-definitions-text' dangerouslySetInnerHTML={{
