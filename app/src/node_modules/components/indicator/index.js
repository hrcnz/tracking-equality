...
//     log('data - filtered', data)
      ...
      howToReadData = this.state.explanationCollapsed
        ? this.truncateText(indicator.howtoreaddata, 45)
        : this.truncateText(indicator.howtoreaddata, 45, true)
      aboutIndicator = this.state.explanationCollapsed
        ? this.truncateText(indicator.aboutindicator, 20)
        : this.truncateText(indicator.aboutindicator, 20, true)
