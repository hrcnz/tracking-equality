          ...
          <div className="page-content-indicator page-content">
            ...
            <Grid className='page-section indicator-section-intro'>
              ...
              <div className="indicator-title">
                <h3>{loading ? "Loading indicator" : indicator.title}</h3>
              </div>

              <Row className='indicator-top'>
                <Col className='indicator-explain' md={9}>
            ...
            <Grid className='page-section indicator-section-chart'>
              <Row className='indicator-chart-top'>
                <Col className='indicator-dimension-filters' md={9}>

                      { this.renderFilterBreakdowns(breakdownOptions) }                

                </Col>
                <Col className='indicator-dataset-filter' md={3}>
                  <FilterDataset
              ...
              <Row className='indicator-chart-main'>
                ...
                <Col className='indicator-chart' md={9}>
                  {ChartComponent}
                </Col>

                <Col className='indicator-group-filter' md={3}>
                  <FilterGroups
                    flux={this.props.flux}
            ...
            <Grid className='page-section indicator-section-analysis'>
              <Row className="indicator-bottom">
               <Col md={9} className='indicator-analysis'>
                  <h2>Analysis</h2>
                  <div
                ...
                <Col className="indicator-sources" md={3}>
