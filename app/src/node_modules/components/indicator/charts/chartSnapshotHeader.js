...
module.exports = React.createClass({
  ...
  renderReferenceLabels: function () {
    var labels = [<span className='small' style={{float: 'left', width: this.props.refLength+'%', marginLeft: -2}}>{this.props.zeroLabel}</span>]
    if (this.props.refLength !== 0 || this.props.refLabel !== '') labels.push(
      <span className='small' style={{float: 'left' }}>{this.props.refDatumLabel + ' ' + this.props.refLabel }</span>
    )
    return labels
  },
