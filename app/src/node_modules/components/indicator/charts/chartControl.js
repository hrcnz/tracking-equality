...
var Snapshot 						= require('./chartSnapshot')
var Timeline 						= require('./chartTimeline')
...
module.exports = React.createClass({
    ...
    ranges      : React.PropTypes.array, // the top/bottom values and group labels for all datasets 
    ...
    if (this.props.datasets.length === 1) {
      return (
        <Snapshot    
          ...
          range = {this.props.ranges[0]} // for first dataset
