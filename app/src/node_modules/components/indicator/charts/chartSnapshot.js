...
module.exports = React.createClass({
          ...
          <table className='table chart-table'>
            <TableHeader
              ...
              refLength       = { refDatum.value === 0 || refDatum.value === '' 
                ? 0
                : this.getBarLength(refDatum.value, this.props.axisScale)}
  ...
  renderRange : function(){
    ...
    if (indicator.datatype === 'categorical' || indicator.datatype === 'part-to-whole' || indicator.multidimensional === 'n') {
      ...
      var top = <TableRow rowData = {this.prepareRowRangeTop()}/>

      var bottom = <TableRow rowData = {this.prepareRowRangeBottom()}/>
...
// render by value ////////////////////////////////////////////////////////////////////
  ...
  prepareBarCell: function (value, maxValue, refValue) {
    ...
    return {
      ...
      label: makeDataLabel(value,this.props.indicator.datatype,this.props.indicator.unit,false),
