...
module.exports = React.createClass({
      ...
      return (
        ...
        <div className='snapshot'>
          <table className='table'>
            ...
            />
            { (this.props.sortBy === 'groups') ? this.renderByGroup() : this.renderByValue() }					
          </table>
        </div>
      )
  },
  ...
  formatRowDataGrouped : function (datum, maxValue, refDatum, currentGroups, indicator) {
    ...
    var rowData = _(this.props.breakdowns).map(function(bd){
        ...
        if (bd.id !== 'cat') {
          ...
          return this.formatGroupCellCategorical (
                  datum.cat,
  ...
  formatGroupCellCategorical : function(short,prevGroup,label) {
    prevGroup = typeof prevGroup !== 'undefined' ? prevGroup : ''
    
     
    // only put label when different from previous group
    if (prevGroup === '' || prevGroup !== short) {    
      return {
        type : 'text',
        label : label,
        className : 'group-label'
