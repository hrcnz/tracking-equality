  ...
  render: function () {
    ...
    return (
      ...
      <div style={{position:'relative'}}>
            ...
            return _.map(group.data,function(d){
              return ( 
                <div className={"line-label"} style={{position:"absolute",top:y(d.y),left:x(d.date)}}>
                  <div className={'inner'}>{d.label}</div>
                </div>
              )                    
            })                  
          })                                
        }
        <div className={'date-axis'} style={{position:"absolute",top:"100%",left:0}}>
          {            
            _.map(this.props.barData,function(dataset){
        ...
        <div className={'value-axis'} style={{position:"absolute",top:0,left:-50}}>
          {            
