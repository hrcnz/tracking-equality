...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
      ...
      <div className="line-chart-header">
        ...
        <div className="line-chart-key key line-chart-key-secondary">
        {  this.renderKeyLower()}
        </div>  
      </div>            
      <Row>
        <Col md={9} className="line-chart-main">
        ...
        <Col className="line-chart-aside" md={3}>
  ...
  renderKey : function(){
    return (
            <div className="key-wrapper pull-right" >
    ...
    return _.map(_.filter(dataByGroup,function(g){return g.state==='active'}),function(g){
      ...
      if (typeof datasetCurrent.range !== 'undefined') {
        if (_.isEqual(g.groupProperties, this.getGroupProperties(datasetCurrent.range.top))) {
          labelRange = 'Least marginalized group, ' + datasetCurrent.observationdate.getFullYear()
        } else if (_.isEqual(g.groupProperties,  this.getGroupProperties(datasetCurrent.range.bottom))) {
          labelRange  = 'Most marginalized group, ' + datasetCurrent.observationdate.getFullYear()
        } 
      }
      return {
