...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var commentary = truncateText(this.props.commentary, 75, !this.state.mainCollapsed)
    var about = truncateText(this.props.about, 50, !this.state.mainCollapsed)
    ...
    return (
      <Grid>
        ...
        <Row className='issue-main'>
          <Col md={8}>
            <h4 className='text-uppercase'> Analysis </h4>
          ...
          <Col md={4}>
            <h4 className={"text-uppercase"}> About this issue </h4>
