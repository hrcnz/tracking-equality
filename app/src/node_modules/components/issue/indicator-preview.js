...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    showLinechartIcon: React.PropTypes.bool,
  ...
  render: function () {
    ...
    return (
        <Col xs={12/this.props.cols} md={12/this.props.cols}>
          <a href="#" className="indicator-preview-tile"
             onClick={this.handleIndicatorClick(slug)}>
            <div className={'indicator-preview-header'}>{title}</div>
            ...
            <div className='indicator-preview-footer'>
                <h5>Explore Data</h5>
                <div className='indicator-preview-icons'>                  
                  <span className="icon-barchart"></span>                
                {
                  this.props.showLinechartIcon ? (
                                          
                    <span className="icon-linechart"></span> 
