    ...
    return (
        <Col xs={12} md={12/this.props.cols}>
          <a href="#" className="indicator-preview-tile"
            ...
            <ul className={'indicator-preview-footer list-inline'}>
              <li>
                <h4 className="text-uppercase">Explore Data</h4>
              </li>
              <li className='pull-right'>
                <div className="icon-barchart"></div>
                { this.props.showLinchartIcon ? <div className="icon-linechart"></div> : null }
              </li>
            </ul>
          </a>
        </Col>
