...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
      <Grid>
        <h2 className={"text-uppercase"}>Indicators</h2>
        {
  ...
  preparePreviewData : function(data,indicator){
      ...
      var previewData = {        
        top : {
          ...
          length : range.top.value > range.bottom.value ? 100 : range.top.value/range.bottom.value*100,
          colour: getDataColour(true)
        },
        bottom : {
          ...
          length : range.top.value < range.bottom.value ? 100 : range.bottom.value/range.top.value*100,
          colour: getDataColour(false)
        },                
      }
