    ...
    return (
      <div className='intro text-center'>
        <Grid>
          <Row className="intro-content">
            <Col md={8} mdPush={2}>
              <h1 className='serif'> Tracking Equality at Work 
                <br/> is an evidential base for monitoring 
                <br/> fairness at work
              </h1>
              <p className='intro-lead serif'>
          ...
          <h4 className="serif intro-explore">Explore indicators by issues</h4>
        </Grid>
        ...
        <div className="serif intro-read-more">
          <a href="#/about">or learn more about this tool here</a>
        </div>
      </div>
    )
  },
